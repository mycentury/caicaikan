...
public class RuleDisplayTimes extends RuleTemplate {
	...
	@Override
	public List<LotteryPredictEntity> excuteRule(List<LotterySsqEntity> list, LotteryRuleEntity rule) throws Throwable {
		List<LotteryPredictEntity> result = new ArrayList<LotteryPredictEntity>();
		Map<Integer, Integer> map = rule.getPeriodsAndweights();
		return result;
	}
